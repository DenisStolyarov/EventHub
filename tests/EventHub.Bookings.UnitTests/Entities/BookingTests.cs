...
namespace EventHub.Bookings.UnitTests.Entities;
...
public class BookingTests
{
    ...
    [Fact]
    public void CreateBooking_EmptyEventId_ThrowsValidationException()
    {
        // Arrange
        DateTime createdAt = new(2026, 6, 1, 10, 0, 0, DateTimeKind.Utc);

        // Act
        Action act = () => new Booking(Guid.NewGuid(), Guid.Empty, Guid.NewGuid(), createdAt);
    ...
    [Fact]
    public void CreateBooking_EmptyUserId_ThrowsValidationException()
    {
        // Arrange
        DateTime createdAt = new(2026, 6, 1, 10, 0, 0, DateTimeKind.Utc);

        // Act
        Action act = () => new Booking(Guid.NewGuid(), Guid.NewGuid(), Guid.Empty, createdAt);
