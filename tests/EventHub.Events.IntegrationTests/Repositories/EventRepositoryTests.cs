...
using EventHub.Events.IntegrationTests.Abstractions;
using EventHub.Events.IntegrationTests.Fixtures;
using EventHub.Events.IntegrationTests.TestData;
using FluentAssertions;

namespace EventHub.Events.IntegrationTests.Repositories;
...
public sealed class EventRepositoryTests(IntegrationTestFixture fixture) : RepositoryTestBase(fixture), IClassFixture<IntegrationTestFixture>
{
    ...
    public async Task GetByIdAsync_ReturnsEvent_WhenExists()
    {
        ...
        await using EventsDbContext ctx = Fixture.CreateContext();
    ...
    public async Task Add_PersistsEvent()
    {
        ...
        // Assert
        await using EventsDbContext verifyCtx = Fixture.CreateContext();
