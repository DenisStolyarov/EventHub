...
namespace EventHub.Events.IntegrationTests.Fixtures;
...
public sealed class IntegrationTestFixture : IAsyncLifetime
{
    ...
    public EventsDbContext CreateContext() => Create<EventsDbContext>();
    ...
    {
        await using EventsDbContext ctx = CreateContext();
