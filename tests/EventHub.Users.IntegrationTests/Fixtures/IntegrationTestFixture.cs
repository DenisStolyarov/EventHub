...
namespace EventHub.Users.IntegrationTests.Fixtures;
...
public sealed class IntegrationTestFixture : IAsyncLifetime
{
    ...
    public UsersDbContext CreateContext() => Create<UsersDbContext>();
    ...
    {
        await using UsersDbContext ctx = CreateContext();
