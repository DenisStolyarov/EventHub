...
using EventHub.Users.IntegrationTests.Abstractions;
using EventHub.Users.IntegrationTests.Fixtures;
using EventHub.Users.IntegrationTests.TestData;
using FluentAssertions;
using Microsoft.EntityFrameworkCore;

namespace EventHub.Users.IntegrationTests.Repositories;
...
public sealed class UserRepositoryTests(IntegrationTestFixture fixture) : RepositoryTestBase(fixture), IClassFixture<IntegrationTestFixture>
{
    ...
    public async Task GetByLoginAsync_ReturnsUser_WhenExists()
    {
        ...
        await using UsersDbContext ctx = Fixture.CreateContext();
    ...
    public async Task Add_PersistsUser()
    {
        ...
        // Assert
        await using UsersDbContext verifyCtx = Fixture.CreateContext();
